...
let certs = [
    {
        ...
        imgSrc: "./components/assets/microsoft-cert.png",
...

    {
        ...
        imgSrc: "./components/assets/google-cert.png",
...
const certsDisplay = document.getElementById("certs-display");
...
var typed = new Typed(".auto-type", {
    strings: ['IT Administrator', 'Full-Stack Web Developer'],
    typeSpeed: 40,
    backSpeed: 80,
    loop: true,
    showCursor: false
